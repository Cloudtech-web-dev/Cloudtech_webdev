...
const transparentText = false;
const syncedBgClassName = "synced-bg";
const syncedBg = transparentText ? ` ${syncedBgClassName}` : "";
    ...
    return (
        ...
        <>
            ...
            <div className="d-none d-lg-block">
                <section className={`w-100 h-100 d-flex position-relative${syncedBg}`}>
                    <div className="position-absolute w-100 h-100 mx-auto"></div>
                    ...
                    <div className="container w-100 h-100 z-1">
                        <div className="row text-center z-1 my-5">
                            <div className="col pt-5 pt-lg-0 mt-5 d-flex flex-column justify-content-center align-items-center z-1" style={{ marginBottom: 20 }}>
                                <h1 className="hero-title-home font-h0 fw-bolder w-75" style={{ marginBottom: 40, marginTop: 14 }}>
                ...
                <section className="w-100 h-100 d-flex position-relative">
                    <div className="position-absolute w-100 h-100 mx-auto"></div>
                    <div className="container w-100 h-100 z-1">
                        <div className="row text-center justify-content-center z-1 my-5">
