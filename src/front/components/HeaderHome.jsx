                    ...
                    <div className="container w-100 h-100 z-1">
                        <div className="row h-100 text-center justify-content-center z-1 my-5 mx-0">
                            <div className="col pt-5 pt-lg-0 mt-5 d-flex flex-column justify-content-center align-items-center z-1" style={{ marginBottom: 20, maxWidth: 1024 }}>
                                ...
                                <p className="font-h3 fw-semibold" style={{ color: "var(--bs-gray-100)", maxWidth: "689px", marginBottom: 63 }}>
                        ...
                        <section className="w-100 vh-100 d-flex position-relative">
                            <div className="container w-100 h-100 z-1">
                                <div className="row h-100 text-center justify-content-center z-1 my-5">
                                    <div className="col pt-5 pt-lg-0 my-5 d-flex flex-column justify-content-center align-items-center z-1 g-0" style={{ flex: "0 1 677px" }}>
                    ...
                    <div className="container w-100 z-1 py-5" style={{minHeight: "100dvw"}}>
                        <div className="row text-center z-1">
                            <div className="col pt-5 pt-lg-0 my-5 d-flex flex-column justify-content-center align-items-center z-1">
                                ...
                                <p className="hero-subtitle-home text-white w-100 mb-5" style={{fontSize: 24}}>
                                    {t('headers.headerHome.headerDescription')}
                                </p>
                        ...
                        <section className="w-100 min-vh-100 d-flex position-relative px-3">
                            <div className="container z-1">
                                <div className="row h-100 text-center z-1">
                                    <div className="col my-5 d-flex flex-column justify-content-center align-items-center z-1 g-0" style={{ flex: "0 1 677px" }}>
                                        ...
                                        <p className="font-p1 mb-5 fw-medium" style={{ color: "var(--bs-gray-100)", fontSize: "1.5rem", letterSpacing: "unset" }}>
                                            {t('headers.headerHome.servicesPresentation.description')}
                                        </p>

                                        <div className="d-flex flex-column justify-content-center flex-md-row gap-3 w-100" style={{ height: 'fit-content'}}>
                                            <Link to="/projects" className="btn btn-outline btn-lg rounded-pill font-p1 px-5" style={{ maxWidth: 419 }}>
                                                {t('headers.headerHome.servicesPresentation.portfolioButton')}
                                            </Link>
                                        </div>
                                    </div>
